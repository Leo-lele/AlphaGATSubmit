...
#
# loss = Batch_Loss(config=None)
# input = torch.tensor([[[1,2,3],[4,5,6],[-1,-1,-1]],[[1,2,4],[1,1,1],[2,4,8]]]).float()
# y = torch.tensor([[[-1,1,2]],[[0,3,5]]]).float()
# loss.loss_covariance_matrix(input)
# loss.forward(input, y)
